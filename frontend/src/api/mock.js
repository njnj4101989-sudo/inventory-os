...
export const rolls = [
  {
    id: uid(8), roll_code: 'KT-2026-0451-COT-GREEN-01', fabric_type: 'Cotton',
  ...
  {
    id: uid(9), roll_code: 'KT-2026-0451-COT-GREEN-02', fabric_type: 'Cotton',
  ...
  {
    id: uid('a'), roll_code: 'KT-2026-0452-COT-RED-01', fabric_type: 'Cotton',
  ...
  {
    id: uid('b'), roll_code: 'KT-2026-0452-COT-RED-02', fabric_type: 'Cotton',
  ...
  {
    id: uid('b1'), roll_code: 'LF-2026-0089-COT-BLACK-01', fabric_type: 'Cotton',
  ...
  {
    id: uid('b2'), roll_code: 'LF-2026-0090-COT-WHITE-01', fabric_type: 'Cotton',
...
export const lots = [
  {
    ...
    lot_rolls: [
      {
        id: uid('d2'), roll_id: uid(8), roll_code: 'KT-2026-0451-COT-GREEN-01', color: 'Green',
      ...
      {
        id: uid('d3'), roll_id: uid(9), roll_code: 'KT-2026-0451-COT-GREEN-02', color: 'Green',
      ...
      {
        id: uid('d4'), roll_id: uid('a'), roll_code: 'KT-2026-0452-COT-RED-01', color: 'Red',
      ...
      {
        id: uid('d5'), roll_id: uid('b'), roll_code: 'KT-2026-0452-COT-RED-02', color: 'Red',
