...
export const suppliers = [
  {
    ...
    broker: 'Ramesh Broker', hsn_code: '5208',
    is_active: true, created_at: '2026-02-07T08:00:00Z',
  },
  {
...
export const rolls = [
  {
    ...
    gst_percent: 12, supplier_invoice_id: uid('si1'),
  ...
  },
  {
    ...
    gst_percent: 5, supplier_invoice_id: uid('si2'),
    received_by_user: { id: uid(2), full_name: 'Ravi Kumar' },
  ...
  },
  {
    ...
    gst_percent: 0, supplier_invoice_id: uid('si3'),
    received_by_user: { id: uid(2), full_name: 'Ravi Kumar' },
  ...
  },
  {
    ...
    gst_percent: 0, supplier_invoice_id: uid('si4'),
    received_by_user: { id: uid(2), full_name: 'Ravi Kumar' },
...
export const lots = [
  {
    ...
    lot_rolls: [
      {
        id: uid('d2'), roll_id: uid(8), roll_code: '1-COT-GREEN-01', color: 'Green',
      ...
      {
        id: uid('d3'), roll_id: uid(9), roll_code: '1-COT-GREEN-02', color: 'Green',
      ...
      {
        id: uid('d4'), roll_id: uid('a'), roll_code: '2-COT-RED-01', color: 'Red',
      ...
      {
        id: uid('d5'), roll_id: uid('b'), roll_code: '2-COT-RED-02', color: 'Red',
...
export const colors = [
  { id: crypto.randomUUID(), name: 'Green',   code: 'GREEN', color_no: 1,  hex_code: '#22c55e', is_active: true },
  { id: crypto.randomUUID(), name: 'Red',     code: 'RED',   color_no: 2,  hex_code: '#ef4444', is_active: true },
  { id: crypto.randomUUID(), name: 'Blue',    code: 'BLUE',  color_no: 3,  hex_code: '#3b82f6', is_active: true },
  { id: crypto.randomUUID(), name: 'Black',   code: 'BLACK', color_no: 4,  hex_code: '#000000', is_active: true },
  { id: crypto.randomUUID(), name: 'White',   code: 'WHITE', color_no: 5,  hex_code: '#ffffff', is_active: true },
  { id: crypto.randomUUID(), name: 'Yellow',  code: 'YELLW', color_no: 6,  hex_code: '#eab308', is_active: true },
  { id: crypto.randomUUID(), name: 'Pink',    code: 'PINK',  color_no: 7,  hex_code: '#ec4899', is_active: true },
  { id: crypto.randomUUID(), name: 'Orange',  code: 'ORNGE', color_no: 8,  hex_code: '#f97316', is_active: true },
  { id: crypto.randomUUID(), name: 'Purple',  code: 'PURPL', color_no: 9,  hex_code: '#a855f7', is_active: true },
  { id: crypto.randomUUID(), name: 'Brown',   code: 'BROWN', color_no: 10, hex_code: '#92400e', is_active: true },
  { id: crypto.randomUUID(), name: 'Grey',    code: 'GREY',  color_no: 11, hex_code: '#6b7280', is_active: true },
  { id: crypto.randomUUID(), name: 'Gray',    code: 'GRAY',  color_no: 12, hex_code: '#9ca3af', is_active: true },
  { id: crypto.randomUUID(), name: 'Mehandi', code: 'MHNDI', color_no: 13, hex_code: '#65a30d', is_active: true },
  { id: crypto.randomUUID(), name: 'Maroon',  code: 'MROON', color_no: 14, hex_code: '#881337', is_active: true },
  { id: crypto.randomUUID(), name: 'Beige',   code: 'BEIGE', color_no: 15, hex_code: '#d4c5a9', is_active: true },
  { id: crypto.randomUUID(), name: 'Magenta', code: 'MGNTA', color_no: 16, hex_code: '#d946ef', is_active: true },
  { id: crypto.randomUUID(), name: 'Peach',   code: 'PEACH', color_no: 17, hex_code: '#fdba74', is_active: true },
  { id: crypto.randomUUID(), name: 'Cream',   code: 'CREAM', color_no: 18, hex_code: '#fef3c7', is_active: true },
  { id: crypto.randomUUID(), name: 'Navy',    code: 'NAVY',  color_no: 19, hex_code: '#1e3a5f', is_active: true },
  { id: crypto.randomUUID(), name: 'Teal',    code: 'TEAL',  color_no: 20, hex_code: '#14b8a6', is_active: true },
  { id: crypto.randomUUID(), name: 'Coral',   code: 'CORAL', color_no: 21, hex_code: '#f87171', is_active: true },
  { id: crypto.randomUUID(), name: 'Rust',    code: 'RUST',  color_no: 22, hex_code: '#b45309', is_active: true },
  { id: crypto.randomUUID(), name: 'Ivory',   code: 'IVORY', color_no: 23, hex_code: '#fffff0', is_active: true },
  { id: crypto.randomUUID(), name: 'Olive',   code: 'OLIVE', color_no: 24, hex_code: '#65a30d', is_active: true },
  { id: crypto.randomUUID(), name: 'Wine',    code: 'WINE',  color_no: 25, hex_code: '#722f37', is_active: true },
]
