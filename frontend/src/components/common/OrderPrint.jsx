...
export default function OrderPrint({ order, companyName, company, onClose, mode = 'confirmation' }) {
  ...
  const S = {
    ...
    th: { padding: '3px 6px', fontSize: '7.5px', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.5px', borderBottom: '1.5px solid #000', borderRight: '1px solid #ccc', background: '#f0f0f0', color: '#000' },
    thLast: { padding: '3px 6px', fontSize: '7.5px', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.5px', borderBottom: '1.5px solid #000', background: '#f0f0f0', color: '#000' },
