...
const NAV_ITEMS = [
  ...
  { path: '/payments',   label: 'Payments',      icon: 'M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z', roles: ['admin', 'billing'] },
  { path: '/returns',    label: 'Returns',       icon: 'M3 10h10a8 8 0 018 8v2M3 10l6 6m-6-6l6-6', roles: ['admin', 'billing'] },
