...
_Last sync: 2026-03-03 20:53:42_
```
{
  "summary": "Project has 14 tracked code files (~6760 lines total).",
  "recent_files": [
    "CLAUDE.md (594 lines)",
    ".claude\\settings.local.json (64 lines)",
    "guardian.md (390 lines)",
  ...
  "total_lines": 6760,
  "last_updated": "2026-03-03 20:53:42"
}
```