...
_Last sync: 2026-02-24 10:21:38_
```
{
  "summary": "Project has 13 tracked code files (~6159 lines total).",
  "recent_files": [
    "CLAUDE.md (777 lines)",
    "guardian.md (351 lines)",
    "project-context.json (17 lines)",
    "API_REFERENCE.md (1135 lines)",
  ...
  "total_lines": 6159,
  "last_updated": "2026-02-24 10:21:38"
}
```