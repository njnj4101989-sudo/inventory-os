...
_Last sync: 2026-03-03 22:56:02_
```
{
  "summary": "Project has 14 tracked code files (~6803 lines total).",
  "recent_files": [
    "CLAUDE.md (634 lines)",
    ".claude\\settings.local.json (65 lines)",
    "guardian.md (392 lines)",
  ...
  "total_lines": 6803,
  "last_updated": "2026-03-03 22:56:02"
}
```