...
_Last sync: 2026-03-16 19:44:14_
```
{
  "summary": "Project has 16 tracked code files (~7962 lines total).",
  "recent_files": [
    "CLAUDE.md (629 lines)",
    "MASTERS_AND_FY_PLAN.md (485 lines)",
    "guardian.md (484 lines)",
  ...
  "total_lines": 7962,
  "last_updated": "2026-03-16 19:44:14"
}
```