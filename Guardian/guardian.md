...
_Last sync: 2026-03-05 23:09:29_
```
{
  "summary": "Project has 14 tracked code files (~6499 lines total).",
  "recent_files": [
    "CLAUDE.md (263 lines)",
    "guardian.md (443 lines)",
    ".claude\\settings.local.json (73 lines)",
  ...
  "total_lines": 6499,
  "last_updated": "2026-03-05 23:09:29"
}
```