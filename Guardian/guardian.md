...
_Last sync: 2026-02-08 00:50:16_
```
{
  "summary": "Project has 12 tracked code files (~3987 lines total).",
  "recent_files": [
    "CLAUDE.md (202 lines)",
    "guardian.md (262 lines)",
    "project-context.json (17 lines)",
    ".claude\\settings.local.json (16 lines)",
    "STEP6_SCAFFOLD_PLAN.md (235 lines)"
  ],
  "language_breakdown": {
    ".md": 9,
    ".py": 1,
  ...
  "total_lines": 3987,
  "last_updated": "2026-02-08 00:50:16"
}
```