...
_Last sync: 2026-04-06 16:55:51_
```
{
  "summary": "Project has 21 tracked code files (~11004 lines total).",
  "recent_files": [
    "CLAUDE.md (325 lines)",
    ".claude\\settings.local.json (153 lines)",
    "guardian.md (683 lines)",
  ...
  "total_lines": 11004,
  "last_updated": "2026-04-06 16:55:51"
}
```