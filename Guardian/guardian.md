...
_Last sync: 2026-03-29 17:42:32_
```
{
  "summary": "Project has 17 tracked code files (~9211 lines total).",
  "recent_files": [
    "CLAUDE.md (799 lines)",
    ".claude\\settings.local.json (127 lines)",
    "guardian.md (644 lines)",
  ...
  "total_lines": 9211,
  "last_updated": "2026-03-29 17:42:32"
}
```