...
_Last sync: 2026-02-27 21:44:55_
```
{
  "summary": "Project has 13 tracked code files (~5765 lines total).",
  "recent_files": [
    ".claude\\settings.local.json (56 lines)",
    "guardian.md (357 lines)",
  ...
  "total_lines": 5765,
  "last_updated": "2026-02-27 21:44:55"
}
```