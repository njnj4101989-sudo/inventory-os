...
_Last sync: 2026-04-06 12:42:26_
```
{
  "summary": "Project has 21 tracked code files (~10989 lines total).",
  "recent_files": [
    "CLAUDE.md (314 lines)",
    ".claude\\settings.local.json (151 lines)",
    "guardian.md (681 lines)",
  ...
  "total_lines": 10989,
  "last_updated": "2026-04-06 12:42:26"
}
```